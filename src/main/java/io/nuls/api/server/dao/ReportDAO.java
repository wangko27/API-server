...
public class ReportDAO {
    ...
    public void mined() {
        ...
        String insertSQL = "INSERT INTO mined_top(CONSENSUS_ADDRESS, AGENT_ADDRESS, MINED_COUNT, REWARD, LAST_HEIGHT, CREATE_TIME) SELECT CONSENSUS_ADDRESS, AGENT_ADDRESS, MINED_COUNT, REWARD, LAST_HEIGHT, ROUND(UNIX_TIMESTAMP(CURTIME(4)) * 1000) FROM mined_top_temp ORDER BY MINED_COUNT DESC ";
        jdbcTemplate.batchUpdate(deleteTempSQL, executeSQL);
        jdbcTemplate.batchUpdate(deteleSQL, insertSQL, deleteTempSQL);
    }
